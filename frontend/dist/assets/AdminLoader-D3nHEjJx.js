import{j as e}from"./index-CkvbSA8D.js";import{L as i}from"./loader-circle-Bl7BWCQh.js";const o=({message:t="Récupération des données en cours..."})=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"80px 20px",color:"var(--text-light)",minHeight:"50vh"},children:[e.jsx("style",{children:`
          @keyframes spin {
